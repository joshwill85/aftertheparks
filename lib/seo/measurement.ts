...
export const PRIORITY_RANK_TRACKING_QUERIES: RankTrackingQuery[] = [
  ...
  { query: "what to do at Disney World on a non park day", canonicalPath: "/activities", pageType: "guide", intent: "non_park_day", reviewCadence: "weekly" },
  { query: "Disney World non park day", canonicalPath: "/activities", pageType: "guide", intent: "non_park_day", reviewCadence: "weekly" },
  { query: "Disney rest day itinerary", canonicalPath: "/activities", pageType: "guide", intent: "non_park_day", reviewCadence: "weekly" },
  { query: "things to do at Disney resorts", canonicalPath: "/activities", pageType: "activity", intent: "non_park_day", reviewCadence: "weekly" },
  { query: "free Disney resort activities", canonicalPath: "/activities?free=true", pageType: "guide", intent: "no_ticket", reviewCadence: "weekly" },
  { query: "free things to do at Disney World resorts", canonicalPath: "/activities?free=true", pageType: "guide", intent: "no_ticket", reviewCadence: "weekly" },
  { query: "Disney World things to do without park tickets", canonicalPath: "/resorts?no_ticket_friendly=true", pageType: "guide", intent: "no_ticket", reviewCadence: "weekly" },
  { query: "Disney resort activities without park ticket", canonicalPath: "/resorts?no_ticket_friendly=true", pageType: "guide", intent: "no_ticket", reviewCadence: "weekly" },
  { query: "can you do Disney resort activities without staying there", canonicalPath: "/resorts?no_ticket_friendly=true", pageType: "guide", intent: "no_ticket", reviewCadence: "weekly" },
  { query: "Disney World no ticket activities", canonicalPath: "/resorts?no_ticket_friendly=true", pageType: "guide", intent: "no_ticket", reviewCadence: "weekly" },
  ...
  { query: "Fort Wilderness activities without park ticket", canonicalPath: "/activities?area=fort-wilderness", pageType: "guide", intent: "transportation_area", reviewCadence: "weekly" },
  { query: "BoardWalk area resort activities", canonicalPath: "/activities?area=epcot-boardwalk", pageType: "guide", intent: "transportation_area", reviewCadence: "weekly" },
  { query: "Disney monorail resort activities", canonicalPath: "/activities?transport=monorail", pageType: "guide", intent: "transportation_area", reviewCadence: "weekly" },
  { query: "Disney Skyliner resort activities", canonicalPath: "/activities?transport=skyliner", pageType: "guide", intent: "transportation_area", reviewCadence: "weekly" },
  { query: "Disney Springs area resort activities", canonicalPath: "/resorts?no_ticket_friendly=true", pageType: "guide", intent: "transportation_area", reviewCadence: "after_major_update" },
  { query: "Disney resort hopping guide", canonicalPath: "/resorts", pageType: "guide", intent: "transportation_area", reviewCadence: "weekly" },
  { query: "rainy day Disney resort activities", canonicalPath: "/activities?weather=indoor", pageType: "guide", intent: "non_park_day", reviewCadence: "weekly" },
  ...
  { query: "first night at Disney resort", canonicalPath: "/tonight", pageType: "guide", intent: "tonight", reviewCadence: "weekly" },
  { query: "Disney check-in day activities", canonicalPath: "/tonight", pageType: "guide", intent: "today", reviewCadence: "weekly" },
  { query: "best Disney resorts for activities today", canonicalPath: "/resorts", pageType: "guide", intent: "today", reviewCadence: "weekly" },
  { query: "best Disney resorts for evening activities", canonicalPath: "/tonight", pageType: "guide", intent: "tonight", reviewCadence: "weekly" },
  { query: "best Disney resorts for toddlers", canonicalPath: "/activities", pageType: "guide", intent: "non_park_day", reviewCadence: "weekly" },
  { query: "best Disney resorts for teens", canonicalPath: "/activities", pageType: "guide", intent: "non_park_day", reviewCadence: "weekly" },
  { query: "best Disney resorts for adults", canonicalPath: "/activities", pageType: "guide", intent: "non_park_day", reviewCadence: "weekly" },
  { query: "best Disney resorts for grandparents", canonicalPath: "/activities", pageType: "guide", intent: "non_park_day", reviewCadence: "weekly" },
  { query: "best Disney resorts for rainy days", canonicalPath: "/activities?weather=indoor", pageType: "guide", intent: "non_park_day", reviewCadence: "weekly" },
  ...
  { query: "Mama's on Vacation Disney non park day", canonicalPath: "/activities", pageType: "guide", intent: "competitor_overlap", reviewCadence: "after_major_update" },
...
export const AI_VISIBILITY_PROMPTS: AiVisibilityPrompt[] = [
  ...
  },
  {
    ...
    expectedCanonicalPath: "/activities?weather=indoor",
    tools: ALL_AI_TOOLS,
  },
  {
    ...
    expectedCanonicalPath: "/resorts?no_ticket_friendly=true",
    tools: ALL_AI_TOOLS,
  },
  {
